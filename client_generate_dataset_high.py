...
# Definisci i limiti per ciascuna giuntura
JOINT_LIMITS = [
    (-0.3, 0.3),  # Giuntura 0: Traslazione
    (-0.8, 0.8),  # Giuntura 1: Traslazione
    (-math.pi, math.pi),  # Giuntura 2: Rotazione
    (-math.pi / 2, math.pi / 2),  # Giuntura 3: Rotazione
    (-math.pi, math.pi),  # Giuntura 4: Rotazione
    (-1.2, 0.15),  # Giuntura 5: Rotazione
    (-math.pi, math.pi),  # Giuntura 6: Rotazione
    (-1.2, 0.15),  # Joint 7: Rotation
    (-math.pi, math.pi),  # Giuntura 8: Rotazione
    (-3 * math.pi / 4, 3 * math.pi / 4),  # Giuntura 9: Rotazione
    (-math.pi, math.pi)  # Giuntura 10: Rotazione
]
...
def generate_constrained_random_joints():
    ...
    joint_values[9] = -3 * math.pi / 4  # Joint 9: HIGH_POSITION
...
def main():
    ...
    # dataset_filename = "High_position_dataset.csv"

    dataset_filename = "datasets/High_position_dataset_test.csv"
