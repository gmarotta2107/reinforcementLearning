...
def generate_constrained_random_joints():
    ...
    joint_values[9] = - math.pi / 3 # Joint 9: MID_POSITION
...
def run_simulation(cli, dataset_filename):
    ...
    with open(dataset_filename, mode='a', newline='') as file:
        ...
        iteration_count = 0
        while iteration_count < 3500:  # Run 3500 iterations
...
def main():
    ...
    #dataset_filename = "Low_position_dataset.csv"

    dataset_filename = "datasets/Low_position_dataset_test.csv"
